...
(function ($) {
  ...
  $("#select-search-2,.kb__select").select2({
    placeholder: "Search...",
    dropdownCssClass: "category-member",
    allowClear: true,
  });
  $("#select-search-3,.kb__select").select2({
    placeholder: "Search...",
    dropdownCssClass: "category-member",
    allowClear: true,
  });
  $("#select-search-4,.kb__select").select2({
    placeholder: "Search...",
    dropdownCssClass: "category-member",
    allowClear: true,
  });
  $("#select-search-5,.kb__select").select2({
    placeholder: "Search...",
    dropdownCssClass: "category-member",
    allowClear: true,
  });
  $("#select-search-6,.kb__select").select2({
    placeholder: "Search...",
    dropdownCssClass: "category-member",
    allowClear: true,
  });
  $("#select-search1,.kb__select").select2({
    placeholder: "Search...",
    dropdownCssClass: "category-member",
    allowClear: true,
  });
  $("#select-search2,.kb__select").select2({
    placeholder: "Search...",
    dropdownCssClass: "category-member",
    allowClear: true,
  });
