...
/* line chart four */
function chartjsLineChartFourExtra(selector, bcolor = "#FA8B0C", height = "95", date1,date2,date3,date4,date5) {
  var ctxs = document.getElementById(selector);
  if (ctxs) {
    ctxs.getContext("2d");
...
function chartjsDoughnut(selector, cHeight, data) {
  ...
  if (ctx) {
    ...
    var chart = new Chart(ctx, {
      type: "doughnut",
      data: {
        labels: ["cheque", "cach", "virement","mad"],
        datasets: [{
          data: data,
          backgroundColor: ["#20C997", "#5F63F2", "#FA8B0C","#72c9d6"],
          total: "9,283",
        }, ],
      },
      options: {
...
function chartjsDoughnutExtra(selector, cHeight,labelsData, data) {
  var ctx = document.getElementById(selector);
  if (ctx) {
    ctx.getContext("2d");
    ctx.height = cHeight;
    var chart = new Chart(ctx, {
      type: "doughnut",
      data: {
        labels: ["Total 3333", "33", "Not 33","3"],
        datasets: [{
          data: data,
          backgroundColor: ["#20C997", "#5F63F2", "#FA8B0C","#FA8B11"],
          total: "9,283",
        }, ],
      },
      options: {
