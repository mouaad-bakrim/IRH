            ...
            <div class="card-body py-md-30">
                <form method="post" action="{{ route('manager.store') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-25">
                            <select class="form-control select " name="profession_id">
                        ...
                        <div class="col-md-6 mb-25">
                            <input type="text" name="SalaireNet" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                   placeholder="SalaireNet">
                        </div>
                        <div class="col-md-6 mb-25">
                            <input type="text" name="SalaireBrut" class="form-control ih-medium ip-gray radius-xs b-light px-15"
                                   placeholder="SalaireBrut">
                        </div>
                                ...
                                <div class="form-group form-group-calender">
                                    <div id="pageWrapper">
                                        ...
                                        <div id="pageContentArea" class="pageSection">
                                            <form>
                                                <input type="text" id="txtDateRange" name="PeriodeDeStage" class="inputField shortInputField dateRangeField form-control  ih-medium ip-gray radius-xs b-light" placeholder="       PeriodeDeStage      Y/W/MMMM - Y/W/MMMM" data-from-field="txtDateFrom" data-to-field="txtDateTo" />
