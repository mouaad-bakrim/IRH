                                    ...
                                    <div class="edit-profile__body">
                                        <form>
                                            ...
                                            <form action="#">
                                                <div class="form-group row mb-n50">
                                                    <div class="col-md-6 mb-25">
                                                        <div class="with-icon">
                                                            ...
                                                            <input type="text"
                                                                   ...
                                                                   id="inputNameIcon" placeholder="    {{__('EmailProfessionnel')}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-25">
                                                    ...
                                                    <div class="col-md-6 mb-25">
                                                        <div class="with-icon">
                                                            ...
                                                            <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light" id="datepicker8" placeholder="       {{__('DateDeNaissance')}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-25">
                                                        <div class="with-icon">
                                                            <span class="la-lock las color-light"></span>
                                                            <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light" id="datepicker6" placeholder="       {{__('DateDexpiration')}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-25">
                                                        <div class="with-icon">
                                                            <span class="la-lock las color-light"></span>
                                                            <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light" id="datepicker7" placeholder="       {{__('DateDembauche')}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-25">
                                                        <div class="with-icon">
                                                            <span class="la-lock las color-light"></span>
                                                            <input type="text" class="form-control  ih-medium ip-gray radius-xs b-light" id="datepicker" placeholder="       {{__('dateDeConfirmation')}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 mb-25">
                                                        <div class="with-icon">
                                                            ...
                                                            <input type="text"
                                                                   class="form-control  ih-medium ip-lightradius-xs b-light"
                                                                   id="inputNameIcon" placeholder="     {{__('SituationFamiliale')}}">
                                                        </div>
                                                    </div>
                                                ...
                                                <div
                                                    class="button-group d-flex pt-3 mb-20 justify-content-between flex-wrap" style="margin-top:20px;">
