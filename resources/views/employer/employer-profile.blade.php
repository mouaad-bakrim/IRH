                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-sub-header">
                            <h3 class="page-title">employer Details</h3>
                            <ul class="breadcrumb">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="employer-profile-head">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="profile-user-box">
                                            <div class="profile-user-img">
                                                <img src="{{ Storage::url('employer-photos/'.$employerProfile->upload) }}" alt="Profile">
                                                <div class="form-group employers-up-files profile-edit-icon mb-0">
                                            ...
                                            <div class="names-profiles">
                                                <h4>{{ $employerProfile->first_name }} {{ $employerProfile->last_name }}</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="employer-personals-grp">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Name</h4>
                                                <h5>{{ $employerProfile->nom }} {{ $employerProfile->prenom }}</h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
                                        ...
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Email</h4>
                                                <h5><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="81e5e0e8f2f8c1e6ece0e8edafe2eeec">{{ $employerProfile->Telephone }}</a>
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                        ...
                                        <div class="personal-activity">
                                            ...
                                            <div class="views-personal">
                                                <h4>Date of Birth</h4>
                                                <h5>{{ $employerProfile->CarteDeSejour }}</h5>
                                            </div>
                                        </div>
                                        <div class="personal-activity">
                                            <div class="personal-icons">
