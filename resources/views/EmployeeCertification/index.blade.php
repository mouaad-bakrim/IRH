                    ...
                    <div class="modal-content  radius-xl">
                        ...
                        <div class="modal-body">
                            <div class="new-member-modal">
                                ...
                                @endif
                                <form action="{{ route('EmployeeCertification.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group mb-20">
                                        <input type="text" name="CertificationName" class="form-control" placeholder="CertificationName">
                                        @error('CertificationName')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group mb-20">
                                        <input type="text" name="AcquisitionDate" class="form-control" placeholder="AcquisitionDate">
                                        @error('AcquisitionDate')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="form-group mb-20">
                                        <input type="text" name="ExpiryDate" class="form-control" placeholder="ExpiryDate">
                                        @error('ExpiryDate')
                                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                        @enderror
                                    </div>
                ...
                <div class="table-responsive">
                    <table class="table mb-0 table-borderless">
                        ...
                        <tr class="userDatatable-header">
                            ...
                            <th>
                                <span class="userDatatable-title">CertificationName</span>
                            </th>
                           <th>
                                <span class="userDatatable-title">AcquisitionDate</span>
                            </th>
                            <th>
                                <span class="userDatatable-title">ExpiryDate</span>
                            </th>
                            <th>
                        ...
                        @foreach ($EmployeeCertification as $company)
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="userDatatable-content">
                                        {{ $company->CertificationName }}
                                    </div>
                                </td>
                                <td>
                                    <div class="userDatatable-content">
                                        {{ $company->AcquisitionDate }}
                                    </div>
                                </td>
                                <td>
                                    <div class="userDatatable-content">
